...
const CommentsForm = ({slug}) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      {error && <p className='text-xs text-red-500'>All field area required</p>}
      <div className='mt-8'>
        <button 
          type="button" 
          onClick={handleCommentSubmission}
          className="tranbsition duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
        >
          Post Comment
        </button>
